...
contract PermitSignature {
    ...
    bytes32 public constant _SPONSOR_PERMIT_TYPEHASH = keccak256(
        "SponsorPermit(uint256 nonce,uint256 deadline,address recipient,uint256 amount,address token,uint256 cooldown,uint256 delay,uint256 terms,uint256 maxProcessingFee,address processingFeeToken,uint256 auctionDuration)"
    );
